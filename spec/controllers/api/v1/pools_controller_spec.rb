  ...
  describe "index" do
    ...
    describe "when logged on" do
      ...
      it "should return json" do
        ...
        expect(response).to  be_successful
        expect(JSON.parse(response.body)).to eq [{"short_name"=>@my_pool.short_name, "name"=>@my_pool.name, "description"=>nil, "identity"=>@identity.short_name, "url"=>"/api/v1/pools/#{@my_pool.short_name}"}]
      end
  ...
  describe "update" do
    ...
    describe "when logged on" do
      ...
      it "should give an error when don't have access to that identity" do
        ...
        expect(response).to respond_not_found
        # json = JSON.parse(response.body)
